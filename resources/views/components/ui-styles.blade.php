...
.ub-indigo { background:#e0e7ff; color:#4338ca; }
.ub-blue   { background:#dbeafe; color:#1d4ed8; }
.ub-green  { background:#d1fae5; color:#065f46; }
.ub-teal   { background:#ccfbf1; color:#0f766e; }
...
.act-btn { display:inline-flex; align-items:center; gap:.4rem; padding:.32rem .75rem; border-radius:7px; border:1px solid var(--border); background:#f8f9fb; font-size:.75rem; font-weight:600; color:var(--t2); cursor:pointer; transition:all .15s; white-space:nowrap; box-shadow:0 1px 2px rgba(0,0,0,.04); }
...
.act-item .act-ico { width:27px; height:27px; border-radius:7px; display:flex; align-items:center; justify-content:center; flex-shrink:0; transition:transform .12s; }
